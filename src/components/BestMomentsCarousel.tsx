...
const BestMomentsCarousel: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Video Modal */}
      <Dialog open={selectedIndex !== null} onOpenChange={() => { setSelectedIndex(null); setShowShareSheet(false); }}>
        <DialogContent className="max-w-md p-0 bg-background border-none overflow-hidden">
            ...
            {selectedMoment && (
              ...
              >
                ...
                >
                  ...
                  {/* Close Button */}
                  <button 
                    onClick={() => { setSelectedIndex(null); setShowShareSheet(false); }}
                  ...
                  <button 
                    ...
                    className="absolute right-4 bottom-20 w-11 h-11 rounded-full bg-background/50 backdrop-blur-sm flex items-center justify-center hover:bg-background/70 transition-colors z-10"
                  >
                    ...
                    {showShareSheet && (
                      <>
                        ...
                        <motion.div
                          ...
                          animate={{ opacity: 1 }}
                          exit={{ opacity: 0 }}
                          className="absolute inset-0 bg-background/40 z-20"
          ...
          {selectedIndex !== null && !showShareSheet && (
