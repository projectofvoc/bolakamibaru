    ...
    return <section className="pb-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {[...Array(10)].map((_, i) => <div key={i} className="space-y-4">
  ...
  return <section className="py-6">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 md:gap-6">
          {visibleArticles.map((article, index) => <Link key={article.id} to={`/news/${article.slug}`}>
            ...
            delay: index * 0.05
              ...
              <div className="relative rounded-lg overflow-hidden bg-card aspect-[4/3]">
                ...
                {/* Club Badge */}
                {article.club && <div className="absolute top-3 right-3">
              ...
              <div className="mt-2 sm:mt-4">
                ...
                <div className="mt-2 sm:mt-3 flex items-center justify-between">
                  <div className="flex items-center gap-1 sm:gap-1.5 min-w-0">
                    ...
                    {article.publisher_verified && <CheckCircle className="hidden sm:block w-3.5 h-3.5 flex-shrink-0 text-primary fill-primary/20" />}
